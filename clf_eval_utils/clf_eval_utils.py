...
def calc_AUC_with_CI(ytest, ypred, curve_type='ROC',
    ...
    if bootstrap: # Bootstrap and calculate auROC
        ...
        for train_index,test_index in StratifiedKFold(n_splits=n_splits, shuffle=True, random_state=0).split(ypred,ytest):
...
def quickplot_eval_3(y_true, y_pred, p_high=1.0):
...
def quickplot_eval_4(y_true, y_pred, p_high=1.0):
